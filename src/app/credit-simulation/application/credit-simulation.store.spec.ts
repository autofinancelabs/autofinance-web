...
function makeSimulation(id = 's-1'): CreditSimulation {
  ...
  return new CreditSimulation({
    ...
    vehicleOfferId: 'vo-1',
    salePrice: pen(16000),
    rate: new Rate({value: 0.15, type: RateType.NOMINAL, capitalization: 1, ratePeriod: null}),
    ...
    grace: [],
    costs: [],
    costOfCapital: new Rate({value: 0.5, type: RateType.EFFECTIVE, capitalization: null, ratePeriod: null}),
